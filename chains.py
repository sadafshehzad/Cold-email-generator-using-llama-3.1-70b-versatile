...
class Chain:
    def __init__(self):
        self.llm = ChatGroq(temperature=0, api_key=os.getenv("GROQ_API_KEY"), model_name="llama-3.1-70b-versatile")
    ...
    def extract_jobs(self, cleaned_text):
        prompt_extract = PromptTemplate.from_template(
            ...
            {page_data}
            ### INSTRUCTION:
            This scraped and cleaned text is from the job description/career's page of a website.
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            Over the years, we have empowered numerous enterprises with tailored solutions, fostering scalability, 
            ...
            Remember you are Sadaf, BDE at ABC company. 
